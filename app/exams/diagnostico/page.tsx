  ...
  return (
    <main style={S.main}>
      ...
      {seleccion && !respondido && (
        <button onClick={confirmarRespuesta} style={{ ...S.btnGold, marginBottom: 12 }}>Confirmar respuesta</button>
      )}
