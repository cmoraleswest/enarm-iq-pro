...
export default function SimuladorLibrePage() {
  ...
  return (
    <main style={S.main}>
      ...
      <div style={{ backgroundColor: '#1a1f2e', borderLeft: '4px solid #3b82f6', borderRadius: 10, padding: 22, marginBottom: 20, maxHeight: '40vh', overflowY: 'auto', WebkitOverflowScrolling: 'touch' }}>
      ...
      {seleccion && !respondido && (
        <button onClick={confirmarRespuesta} style={{ ...S.btnBlue, marginBottom: 12 }}>Confirmar respuesta</button>
      )}
