...
export default function UpgradePage() {
  ...
  return (
    <main style={{ minHeight: '100vh', backgroundColor: '#0f0f1a', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, fontFamily: 'Georgia, serif' }}>
      <div style={{ width: '100%', maxWidth: 460, backgroundColor: '#111827', borderRadius: 16, padding: '40px 32px', border: '1px solid #D4AF37' }}>
        <div style={{ fontSize: '2.5rem', textAlign: 'center', marginBottom: 12 }}>🎓</div>
        <h1 style={{ color: '#D4AF37', fontSize: '1.6rem', margin: '0 0 8px 0', letterSpacing: 2, textAlign: 'center' }}>ACTIVA TU ACCESO PRO</h1>
        ...
        {[{ key: 'annual', label: 'Plan Anual', sub: 'AHORRA 41% · Más popular', price: '$599', per: 'MXN/año', color: '#4ade80' },
          ...
          <div key={p.key} onClick={() => setPlan(p.key as 'monthly' | 'annual')}
            ...
            <div style={{ textAlign: 'right' }}>
              <div style={{ color: '#D4AF37', fontSize: '1.3rem', fontWeight: 'bold' }}>{p.price}</div>
        ...
        <button style={{ width: '100%', padding: 16, backgroundColor: '#D4AF37', color: '#0f0f1a', border: 'none', borderRadius: 12, fontSize: '1rem', fontWeight: 'bold', cursor: 'pointer', letterSpacing: '1px', fontFamily: 'Georgia, serif', marginTop: 20 }}
        ...
        {userInfo?.referralCode && (
          <div style={{ marginTop: 24, padding: 16, backgroundColor: '#0f172a', borderRadius: 12, border: '1px solid #334155', textAlign: 'center' }}>
            ...
            <div style={{ backgroundColor: '#1e293b', borderRadius: 8, padding: '8px 12px', fontSize: '0.8rem', color: '#D4AF37', fontFamily: 'monospace', marginBottom: 10 }}>
